...
* Die from other causes: $\delta_0 = 1.182 \times 10^{-3}$
...
<div class = "blue">
C2. Extend the model of C1 for multiple cycles and thus create a Markov-cycle tree and calculate the mean quality-adjusted durations.
</div>
<br><br>
...
<div class = "blue">
C4. Create the equivalent discrete-time Markov model to the one-cycle Markov-cycle tree.
</div>
<br><br>

#### 5. Calculate mean QALYs {#C5}

Now we will use the QALYs provided in C2 in the discrete-time Markov model.
