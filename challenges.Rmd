...
Taken from [ref](Hazen).
Competing cance and AIDS risks decision tree.
...
include_graphics("figs/one_cycle_markov_cycle_tree.png")
```
...
This is done by rolling back using the recursive equation (value iteration):
